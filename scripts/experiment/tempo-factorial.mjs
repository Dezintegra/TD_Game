 ...
 *
 * Здесь величин БОЛЬШЕ, чем в `FACTORS`, и так и задумано: полный перебор
 * растёт втрое с каждой добавленной, а точечная развёртка перебирает
 * ровно то, о чём спросили. Награда за убийство (`killBounty`) заведена
 * именно так — без неё матрица выросла бы с 243 ячеек до 729.
 */
const FLAG_OF = {
  income: '--income',
  speed: '--speed',
