# pipeline-deploy-sandbox-access Specification

## Purpose

Keep Windows Codex deployments able to install package-local dependencies in their assigned snapshots without broadening other stages' sandbox permissions.
