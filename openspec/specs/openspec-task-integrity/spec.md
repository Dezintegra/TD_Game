# openspec-task-integrity Specification

## Purpose
Keep unfinished OpenSpec implementation steps visible to pipeline stages and require delivery evidence before a task is reported done.
## Requirements
