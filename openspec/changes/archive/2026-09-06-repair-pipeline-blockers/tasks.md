...
- [x] 5.4 Post-archive review: reserve a full cycle for exactly one ready exclusive continuation; create and read stateful supervisor runtime only after shared-lock ownership.
