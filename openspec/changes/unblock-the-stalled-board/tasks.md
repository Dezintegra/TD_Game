...
- [x] 6.1 Ввести условие запуска пакета в `supervisor/lib/scan.mjs`: не меньше
...
- [x] 6.2 Хранить время прошлой выкладки в состоянии конвейера: записывать при
...
- [x] 6.3 Согласовать спеку соседнего изменения: сценарий «Единственная задача
...
- [x] 7.1 Завести `scripts/ensure-deploy-host.mjs`: проверка доступности хоста,
...
- [x] 7.2 Разрешить сценарий конвейеру и переписать скилл выкладки: снять запрет
