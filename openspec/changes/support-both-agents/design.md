...
Пользователь выбрал подписку ChatGPT: codexMaxTaskCostUsd=null по умолчанию, отдельно от maxTaskCostUsd Claude (25). Выбор провайдера применяет только его потолок.
