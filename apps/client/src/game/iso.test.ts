...
describe('видимая доля карты', () => {
  it('при окне 1920 × 1080 видно от 25 до 55 процентов карты', () => {
    // Диапазон вырос вместе с уменьшением карты вчетверо: масштаб клетки
    // остался прежним, а клеток стало меньше. Верхняя граница важна
    // не меньше нижней — карта целиком на экран помещаться не должна,
