 ...
 * После двух уменьшений подряд числа перестали ему отвечать, а держалось
 * оно не на доводе: съедает корпус не длина факела, а его ненаправленность.
 * Требование, живущее в комментарии вопреки числам, вреднее отсутствия
 * требования — следующий читатель поверит ему, а не коду.
 */
