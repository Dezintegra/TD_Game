 ...
 * Это сознательный долг, и с 23.08.2026 он созрел: изменение
 * `turn-boxes-into-armour`, которое переписывало `models.ts` целиком
 * и мешало выносу, заархивировано. Причина отсрочки исчезла, вынос
 * общего модуля не сделан — дублируется около сорока строк: поворот
 * местных координат в мировые и укладка граней в заливки.
 *
 * Чем это грозит: первая же правка освещения, сделанная в одной копии,
 * разведёт технику и постройки по разным мирам. Разбор —
 * `openspec/changes/archive/2026-08-23-turn-fire-into-spectacle/design.md`,
 * решение 8.
 */
