...
export const SOUND_PEAK: Readonly<Record<Sound, number>> = {
  ...
  [Sound.NukeFall]: 0.5,
  [Sound.NukeBlast]: 1,
  // Тише прочего вдвое: ротор звучит НЕПРЕРЫВНО, и уровень, который
  // у одиночного события читается умеренным, у непрерывного
  // становится фоном, поверх которого не слышно ничего.
  [Sound.Rotor]: 0.34,
};
