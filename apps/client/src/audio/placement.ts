 ...
 * потом ещё раз — вместе с укорочением самого отклика. На поле, где
 * одновременно грохочет десяток источников, любое эхо складывается само
 * с собой и превращается в кашу быстрее, чем успеет дать простор.
 *
