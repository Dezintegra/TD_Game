...
/**
 * Состав манер: что игрок видит в выборе соперника и чем каждая играет.
 *
 ...
 *
 * `title` — то, как манера называется игроку в комнате. Прежде это было
 * название дежурной комнаты, и его длину ограничивал предел названия
 * комнаты в двадцать знаков; дежурных комнат больше нет, и предел
 * с названий манер снят.
 */
