...
describe('детерминизм симуляции', () => {
  ...
  it('совпадает с эталонной контрольной суммой', () => {
    // Эталон вычислен на правилах из изменений refine-targeting-and-ai-posture
    // (генерал выше юнитов в выборе цели) и add-detailed-models (у юнита
    // и генерала появился румб разворота). Румб на правила не влияет —
    // ни одно из них его не читает, — но в состоянии мира он лежит,
    // а значит, входит в сумму.
    //
    // Предыдущий эталон, 1238608979, отвечал правилам refine-combat-and-view:
    // карта 48 × 48, линия огня, остановка юнита на встречном противнике,
    // производство без отката.
    //
    // Меняйте его ТОЛЬКО вместе с намеренным изменением игровых правил,
    // и тем же коммитом — тогда история баланса видна в diff.
    const GOLDEN_CHECKSUM = 519025619;
