...
describe('детерминизм симуляции', () => {
  ...
  it('совпадает с эталонной контрольной суммой', () => {
    ...
    // до пяти клеток, а у снайпера и гранатомётчика появились ветки
    ...
    //
    // Последним добавился разворот постройки. Правила боя он не трогает:
    ...
    //
    // Предыдущие эталоны: 2055560148 — режимы атаки; 1886512028 — снос;
    ...
    const GOLDEN_CHECKSUM = 1549904538;
