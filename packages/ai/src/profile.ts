...
export interface AiProfile {
  ...
  readonly nuke: {
    ...
    /**
     * Покупает ли профиль ветки мощности заряда и радиуса поражения.
     *
     * Отсутствует — не покупает, и это не осторожность, а необходимость.
 ...
 * держится на втором названном решении — `nuke.upgrade`, см. ниже.
 *
...
export const STRATEGIST_PROFILE: AiProfile = deepFreeze({
  ...
  nuke: { ...BASELINE_PROFILE.nuke, upgrade: true },
});
