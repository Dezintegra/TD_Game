 ...
 *
 * Почему хватает одного числа. Неприкосновенный запас под удар держится,
 * только пока достижим за горизонт накопления (`reserveOf`). Удар стоит
 * полсотни стоимостей юнита, при базовых сорока пяти секундах он
 * недостижим никогда, запас считается нулевым — и до удара дело
 * не доходит. Замер это подтвердил прямо: у базового профиля
