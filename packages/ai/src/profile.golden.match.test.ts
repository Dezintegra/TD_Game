 ...
 *
 * Настройка ядерки (`tune-the-nuke`) повторила то же самое в третий
 * раз: сумма сдвинулась, наблюдаемые величины не дрогнули ни на единицу —
 * построек шесть, войска четырнадцать, прокачки тринадцать уровней,
 * энергии 852, генерал на той же доле пути.
 *
 * И это ровно то, чего следовало ждать. Базовый профиль в ракету
 ...
 *
 * Предыдущие числа: 2732107945 — прокачка мощности и радиуса;
 ...
 */
const GOLDEN_CHECKSUM = 3375105465;
