 ...
 *
 * Предыдущие числа: 161109159 снято на `build-towers-in-force`
 * (постройка группой и достижимый ядерный запас), 502076340 — на пяти
 * изменениях до него.
 */
const GOLDEN_CHECKSUM = 3349686969;
