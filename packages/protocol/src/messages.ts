 ...
 *
 * Пятёрка — вместе с новой генерацией мира, и это единственный случай,
 * когда раскладка байтов НЕ менялась. Изменился смысл: один и тот же seed
 * строит теперь другую карту. Клиент прежней сборки, подключившись,
 * построил бы поле 48 × 48, разошёлся бы с сервером на первом же движении
 * и узнал бы о несовместимости из расхождения посреди матча вместо отказа
 * при подключении.
 */
