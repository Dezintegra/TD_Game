 ...
 * которых хватает любому виду. Клетка — два байта (на карте 38 × 38 это
 * 1444 клетки, и запас в два байта переживёт ещё не одно изменение
 * размера поля), всё остальное — по одному. Разбирать аргументы по видам
