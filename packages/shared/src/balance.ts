...
export const ShotWeapon = {
  /** Трассер: тонкий отрезок. Штурмовик, базовая башня, генерал. */
  Bolt: 0,
...
/** Оружие генерала. Истребитель бьёт очередями, а не лучом. */
export const GENERAL_WEAPON: ShotWeapon = ShotWeapon.Bolt;
