...
/**
 * Юг. Направление по умолчанию для всего, что обязано куда-то смотреть.
 *
 * Выбран не случайно: в нашей проекции южная грань обращена к зрителю,
 * поэтому объект, повёрнутый на юг, показывает себя лицом.
 */
